...
from compiler.utils.player.define import parse_define
from compiler.utils.code.errors import error

from compiler.lexer.lexer import Lexer
from compiler.utils.player.imports import expand_imports
from compiler.lexer.tokens import TOKENS_TEXT
...
class Parser:
    ...
    def eat(self, expected_type):
        if self.current.type != expected_type:
            error(self, f"Ожидалось '{TOKENS_TEXT[expected_type]}', но получено '{TOKENS_TEXT[self.current.type]}'")
